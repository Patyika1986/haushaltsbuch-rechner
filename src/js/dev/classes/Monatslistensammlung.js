...
export default class Monatslistensammlung {
    ...
    /*
       ...
       ein Monatslistensammlungs-Objekt.
    */
    constructor() {
        this._monatslisten = [];
    ...
    /*
     Sortiert die Monatslistensammlung (this._monatslisten) absteigend nach dem 
    ...
    /*
      Diese Methode aktualisiert die Monatslistensammlung
     */
    ...
    /*
      Diese Methode entfernt eine bereits bestehende Monatslistensammlung, wenn vorhanden.
     */
    _entfernen() {
